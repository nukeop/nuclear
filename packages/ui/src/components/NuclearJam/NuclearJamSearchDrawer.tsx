...
export const NuclearJamSearchDrawer: FC<NuclearJamSearchDrawerProps> = ({
  ...
  <Transition show={open}>
    ...
    >
      ...
      <TransitionChild>
        <div className="bg-background border-border absolute inset-x-0 top-0 flex max-h-3/4 min-h-40 flex-col border-b-(length:--border-width) transition duration-200 ease-out data-closed:-translate-y-full">
          {children}
        </div>
      </TransitionChild>
    </div>

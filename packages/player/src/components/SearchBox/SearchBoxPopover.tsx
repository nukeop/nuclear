    ...
    <AnimatePresence>
      {isOpen && hasHistory && (
        <motion.div
          ...
          className="surface-popover border-border absolute top-full right-0 left-0 z-50 mt-2 overflow-hidden rounded-md border-(length:--border-width) backdrop-blur-xl"
        >
          <Popover.Menu>

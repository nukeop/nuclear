...
export const CORE_SETTINGS: SettingDefinition[] = [
  ...
  },
  {
    ...
    title: 'preferences.window.closeToTray.title',
    description: 'preferences.window.closeToTray.description',
    category: 'general',
    kind: 'boolean',
    default: false,
    widget: { type: 'toggle' },
  },
  {
    ...
    title: 'preferences.window.minimizeToTray.title',
    description: 'preferences.window.minimizeToTray.description',
    category: 'general',
    kind: 'boolean',
    default: false,
    widget: { type: 'toggle' },

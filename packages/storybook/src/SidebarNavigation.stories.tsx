...
export const FlatList = () => (
  <div className="surface-muted border-border h-96 w-64 border-(length:--border-width) p-2">
    <SidebarNavigation>
...
export const CompactMode = () => (
  <div className="surface-muted border-border flex h-[600px] w-[54px] flex-col border-(length:--border-width) p-2">
...
export const FullNavigationExample = () => (
  <div className="surface-muted border-border h-[600px] w-64 overflow-auto border-(length:--border-width) p-2">
    <SidebarNavigation>
      <SidebarNavigationItem
        icon={<Home size={16} />}
        label="Home"

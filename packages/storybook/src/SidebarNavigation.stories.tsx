...
export const FlatList = () => (
  <div className="bg-muted border-border h-96 w-64 border-(length:--border-width) p-2">
    <SidebarNavigation>
...
export const CompactMode = () => (
  <div className="bg-muted border-border flex h-[600px] w-[54px] flex-col border-(length:--border-width) p-2">
...
export const FullNavigationExample = () => (
  <div className="bg-muted border-border h-[600px] w-64 overflow-auto border-(length:--border-width) p-2">
    <SidebarNavigation>
      <SidebarNavigationItem
        icon={<Home size={16} />}
        label="Home"

...
export const useCommandPaletteActions = (): CommandPaletteAction[] => {
  ...
  return [{
    ...
    onUse: () => dispatch(playerActions.startPlayback)
  }, {
    id: 'pause',
    ...
    icon: 'pause',
    category: t('categories.playback'),
    onUse: () => dispatch(playerActions.pausePlayback)
  }, {
    id: 'next',
    name: t('actions.next'),
  ...
  },
  {
    ...
    icon: 'random',
    category: t('categories.playback'),
    onUse: useToggleOptionCallback(toggleOption, 'shuffleQueue', settings)
  }, {
    id: 'loop',
    name: t('actions.loop'),
    icon: 'repeat',
    category: t('categories.playback'),
    onUse: useToggleOptionCallback(toggleOption, 'loopAfterQueueEnd', settings)
  }, {
    id: 'autoradio',
    name: t('actions.autoradio'),
    icon: 'magic',
    category: t('categories.playback'),
    onUse: useToggleOptionCallback(toggleOption, 'autoradio', settings)    
  }, {
    id: 'raise-volume',
    name: t('actions.raise-volume'),
    icon: 'volume up',
    category: t('categories.playback'),
    onUse: () => updateVolume(volume + 5)
  }, {
    id: 'lower-volume',

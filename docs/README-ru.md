...
Он также больше фокусируется на аудио. Представьте себе Spotify с большой библиотекой за который не нужно платить.
...
- Очередь песен, которые можно экспортировать в виде плейлиста
...
Мы бы хотели искренне поблагодарить их за вклад в развитие нашего приложения.
...
![Вид страницы артиста](https://i.imgur.com/imBLYl3.png)
...
## Атрибуты
Использование данных SponsorBlock лицензировано в соответствии с [CC BY-NC-SA 4.0](https://creativecommons.org/licenses/by-nc-sa/4.0/) с сайта https://sponsor.ajay.app/.
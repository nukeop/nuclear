    ...
    <div className="play_options_controls">
      <div
        className={classnames('icon', {
          active: props.settings.loopAfterQueueEnd,
        })}
        onClick={() =>
          props.toggleOption(
      ...
      <div
        className={classnames('icon', { active: props.settings.shuffleQueue })}
        onClick={() =>
          props.toggleOption(
      ...
      <div
        className={classnames('icon', { active: props.settings.autoradio })}
        onClick={() =>
          props.toggleOption(
            _.find(settingsConst, { name: 'autoradio' }),
            props.settings
          )
        }
      >
